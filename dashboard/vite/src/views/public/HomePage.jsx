    ...
    >
      ...
      >
        ...
        <Typography variant="body1" sx={{ mb: 4, color: '#555' }}>
          Supporta helps small businesses deliver fast, 24/7 customer support with an AI-powered chatbot
          that feels human. Easy to set up, customizable, and always there when your customers need it.
        </Typography>
